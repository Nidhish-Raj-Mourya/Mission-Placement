...
int largest(int firstNumber)
{
    ...
    if(variable1>variable2 and variable1>variable3 and variable1>variable4){
        cout<<"variable 1 is the largest : "<<variable1;
    }
    else if(variable2>variable3 and variable2>variable4){
        cout<<"variable 2 is the largest : "<<variable2;
    }
    else if(variable3>variable4){
        cout<<"variable 3 is the largest : "<<variable3;
    }
    else{
        cout<<"variable 4 is the largest : "<<variable4;
    }
    return 0;
}
int main(){
